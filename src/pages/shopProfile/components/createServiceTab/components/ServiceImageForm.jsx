...
export default function ServiceImageForm({ setImages }) {
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row justify-start items-start gap-2 p-2 w-full overflow-y-auto flex-wrap rounded bg-main-100 dark:bg-main-900">
        ...
        <div className="flex justify-start items-start gap-2 p-2 w-1/2 overflow-y-auto flex-wrap rounded bg-main-100 dark:bg-main-900">
          {previewUrl.length !== 0
